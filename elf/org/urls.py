...
urlpatterns = [
    ...
    path('toggle_status/<int:lost_item_id>/', views.lost_toggle_status, name='lost_toggle_status'),
    ...
    path('toggle_status/<int:found_item_id>/', views.found_toggle_status, name='found_toggle_status'),
]